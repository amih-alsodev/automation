...
class APISpecificationValue:
    ...
    def get_specification_details_by_id(self, playwright: Playwright, specification_value_id: str, site_token: str,
                                        api_token: str):
        """
    ...
    def update_one_key_of_specification_with_id(self, playwright: Playwright, specification_value_id: str, payload: dict,
    ...
    def delete_specification_by_id(self, playwright: Playwright, specification_value_id: str, site_token: str,
                                   api_token: str):
        """
