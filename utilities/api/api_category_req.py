...
class APICategory:
    ...
    def create_category(self, playwright: Playwright, payload: dict, site_token: str, api_token: str):
        """
    ...
    def get_categories_list(self, playwright: Playwright, site_token: str, api_token: str):
        """
    ...
    def get_category_details_by_id(self, playwright: Playwright, category_id: str, site_token: str, api_token: str):
        """
    ...
    def update_one_key_of_category_with_id(self, playwright: Playwright, category_id: str, payload: dict,
                                           site_token: str,
                                           api_token: str):
        """
    ...
    def delete_category_by_id(self, playwright: Playwright, category_id: str, site_token: str, api_token: str):
        """
